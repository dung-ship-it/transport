...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($_POST['action'] === 'check_in') {
        ...
        try {
            $pdo->prepare("UPDATE hr_attendance SET check_out=?,
...
<div class="driver-header">
    <div class="d-flex justify-content-between align-items-start">
        ...
        <div class="text-end">
            ...
            <div style="font-size:.72rem;opacity:.65;margin-top:4px;"><?= date('l') ?></div>
        </div>
    </div>
</div>
...
<div class="card-mobile" style="margin-top:0;">
    ...
    <div class="px-4 py-3 <?= $i<count($notifications)-1?'border-bottom':'' ?>">
        <div class="fw-semibold" style="font-size:.85rem;"><?= htmlspecialchars($n['title']) ?></div>
