                            ...
                            <div class="d-flex gap-1 flex-wrap">
                                ...
                                <form method="POST" class="d-inline">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-outline-danger"
                                            onclick="return confirm('Xoá bản ghi xăng dầu ngày <?= date('d/m/Y', strtotime($log['log_date'])) ?> của xe <?= $log['plate_number'] ?>?')"
                                            title="Xoá">
                                ...
                                <!-- Đã duyệt: chỉ admin/kế toán mới sửa/xoá -->
                                <a href="edit.php?id=<?= $log['id'] ?>"
                                   class="btn btn-sm btn-outline-primary"
                                   title="Chỉnh sửa (đã duyệt)">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form method="POST" class="d-inline">
                                    <input type="hidden" name="delete_id" value="<?= $log['id'] ?>">
                                    <button type="submit" class="btn btn-sm btn-outline-danger"
                                            onclick="return confirm('⚠️ Bản ghi này đã được duyệt. Bạn vẫn muốn xoá?')"
                                            title="Xoá (đã duyệt)">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                </form>
